...
export default class MainPage extends React.Component {
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          <View style={{ padding: 20 }}>
            ...
            <Text style={{ color: '#d71345', fontSize: 14 }}>开灯测试</Text>
            <TouchableOpacity style={styles.btnStyle} onPress={() => { this.openTheLight(); }}>
              <Text style={styles.textStyle}>开灯！</Text>
            </TouchableOpacity>
  ...
  setDevicePropsValue() {
    ...
    let params = [
      ...
      { did: Device.deviceID, siid: 2, piid: 1, value: true }
    ];
 ...
 */
  ...
  openTheLight() {
    ...
    Service.spec
      ...
      .then((res) => {
        Logger.log('spec string: ', res);
      })
      .catch((error) => {
        Logger.trace('getSpecString error', error);
      });

    this.setDevicePropsValue()
  }
